...
function Intro() {
    ...
    useEffect(() => {
        const fun = async() => {
            const res = await axios.get("https://api.countapi.xyz/update/karthikey/portfolio?amount=1");
    ...
    <div className="container upper-margin">
        ...
        <div className="row center-text">
            ...
            <ScrollAnimation animateIn="slideInRight" duration={1.5}>
                <p> Hello There! </p>
                <p> I am <b> Karthikey Saxena </b>, an aspiring Software Engineer </p>
                <div class="center-text">
                    <a href="#about"> <button type="button" class="btn btn-dark expand"> Know More... </button> </a>
               </div>
            </ScrollAnimation>
            </div>
        </div>
